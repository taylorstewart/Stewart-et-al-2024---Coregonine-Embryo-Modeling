...
spawn.start <- read_excel("data/lake-konnevesi-albula/lake-konnevesi-spawning-albula.xlsx", sheet = "lake-konnevesi-spawning") %>%
  group_by(year) %>% 
  filter(row_number() == 1) %>% 
  select(year, start.date = date)
spawn.end <- read_excel("data/lake-konnevesi-albula/lake-konnevesi-spawning-albula.xlsx", sheet = "lake-konnevesi-spawning") %>%
  group_by(year) %>% 
  filter(row_number() == n()) %>% 
...
mu.hatch <- read_excel("data/lake-konnevesi-albula/lake-konnevesi-hatching-albula.xlsx", sheet = "lake-konnevesi-hatching") %>% 
  group_by(year) %>% 
...
temp.spawn.obs <- read_excel("data/lake-konnevesi-albula/lake-konnevesi-spawning-albula.xlsx", sheet = "lake-konnevesi-spawning") %>% 
  group_by(year) %>% 
...
temp.hatch.obs <- read_excel("data/lake-konnevesi-albula/lake-konnevesi-hatching-albula.xlsx", sheet = "lake-konnevesi-hatching") %>% 
  group_by(year) %>% 
  filter(row_number() == 1 | row_number() == n()) %>% 
