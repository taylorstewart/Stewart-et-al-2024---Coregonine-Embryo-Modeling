...
temp.1 <- read_excel("data/LakeOntario_Temp_CompositeAverage.xlsx", sheet = "2016")
temp.2 <- read_excel("data/LakeOntario_Temp_CompositeAverage.xlsx", sheet = "2017")
temp.3 <- read_excel("data/LakeOntario_Temp_CompositeAverage.xlsx", sheet = "2018")
...
ggsave("figures/LakeOntario-ModelComparison.png", height = 6.5, width = 14, dpi = 300)
...
ggsave("figures/LakeOntario-ADD-Jday.png", plot = plot.all, width = 8, height = 5, dpi = 300)
