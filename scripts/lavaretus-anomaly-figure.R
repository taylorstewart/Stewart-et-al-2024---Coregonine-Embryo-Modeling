...
plot.spawn.anomaly.LG <- ggplot(simulation.anomaly.LG, aes(x = year.class, y = mean.spawn.yday.anomaly, group = scenario)) +
...
plot.dpf.anomaly.LG <- ggplot(simulation.anomaly.LG, aes(x = year.class, y = mean.dpf.anomaly, group = scenario)) +
  geom_hline(yintercept = 0, color = "gray70") +
  geom_line(aes(color = scenario, linetype = scenario),
            size = 1, alpha = 0.9) + 
...
plot.hatch.anomaly.LG <- ggplot(simulation.anomaly.LG, aes(x = year.class, y = mean.hatch.yday.anomaly, group = scenario)) +
  geom_hline(yintercept = 0, color = "gray70") +
  geom_line(aes(color = scenario, linetype = scenario),
            size = 1, alpha = 0.9) + 
...
plot.all <- grid.arrange(
  arrangeGrob(plot.spawn.anomaly.LG,
              plot.dpf.anomaly.LG,
              plot.hatch.anomaly.LG,
              ncol = 1),
  ncol = 2
)
...
simulation.anomaly.LG.noHist <- simulation.anomaly.LG %>% filter(scenario != "Historical")

## Lake Superior - Apostle Islands
plot.spawn.anomaly.LG.noHist <- ggplot(simulation.anomaly.LG.noHist, aes(x = year.class, y = mean.spawn.yday.anomaly, group = scenario)) +
  geom_hline(yintercept = 0, color = "gray70") +
  geom_line(aes(color = scenario, linetype = scenario),
            size = 1, alpha = 0.9) + 
  scale_y_continuous(limits = c(-7, 36), breaks = seq(-5, 35, 5), expand = c(0, 0)) +
...
plot.dpf.anomaly.LG.noHist <- ggplot(simulation.anomaly.LG.noHist, aes(x = year.class, y = mean.dpf.anomaly, group = scenario)) +
  geom_hline(yintercept = 0, color = "gray70") +
  geom_line(aes(color = scenario, linetype = scenario),
            size = 1, alpha = 0.9) + 
  scale_y_continuous(limits = c(-51, 11), breaks = seq(-50, 10, 10), expand = c(0, 0)) +
...
plot.hatch.anomaly.LG.noHist <- ggplot(simulation.anomaly.LG.noHist, aes(x = year.class, y = mean.hatch.yday.anomaly, group = scenario)) +
  geom_hline(yintercept = 0, color = "gray70") +
  geom_line(aes(color = scenario, linetype = scenario),
            size = 1, alpha = 0.9) + 
  scale_y_continuous(limits = c(-21, 12), breaks = seq(-20, 10, 5), expand = c(0, 0)) +
...
plot.all.noHist <- grid.arrange(
  arrangeGrob(plot.spawn.anomaly.LG.noHist,
              plot.dpf.anomaly.LG.noHist,
              plot.hatch.anomaly.LG.noHist,
              ncol = 1),
  ncol = 2
)
